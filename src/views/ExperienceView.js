...
export default function ExperienceView() {
    return (
        ...
        >
            <Header title={experienceData.pageTitle} subtitle={experienceData.pageSubtitle} />
                                ...
                                <div className="flex flex-col md:flex-row items-start gap-4 mb-6">
                                    ...
                                    <div className="flex-grow w-full text-center md:text-left">
                                        <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                            <div>
                                                <h3 className="text-xl font-bold text-white leading-tight">{job.company}</h3>
                                                <div className="text-lg text-gray-300 font-medium mt-1">{job.position}</div>
                                            </div>
